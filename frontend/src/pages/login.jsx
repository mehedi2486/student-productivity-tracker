...
export function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-slate-950 relative overflow-hidden">
      ...
      <div className="absolute -bottom-40 -right-40 w-80 h-80 bg-purple-500/15 rounded-full blur-3xl" />
      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="bg-white/[0.04] backdrop-blur-xl border border-white/10 rounded-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-slate-400 mt-1">Sign in to continue your learning journey</p>
          </div>
          ...
          <p className="text-center mt-6 text-sm text-slate-500">
            ...
            <Link to="/signup" className="text-indigo-400 font-medium hover:text-indigo-300">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
